...
const Info = () => {
  ...
  useEffect(() => {
    const organizationSchema = {
      ...
      slogan:
        currentLang === "en"
          ? "30 Years of Trust, Professional Legal Services"
          : "30년 신뢰, 전문 법률 서비스",
      awardOrAccreditation: [
        "부산시 남구 선거관리위원회 위원",
        "한국전기통신공사 법률고문",
        "사법시험 35회 합격",
      ],
  ...
  return (
    <>
      <div style={{ position: "absolute", left: "-9999px", top: "-9999px" }}>
        <h1>법무법인 동래 소개 - 부산 30년 경력 전문 변호사</h1>
        <h2>1995년 설립, 30,000건 해결 경험</h2>
        <p>
          이태환 대표변호사(사법시험 35회) 직접 상담. 건설분쟁 500건+ 승소율
          92%, 형사변호 800건+ 경험의 부산 연제구 법무법인입니다.
        </p>
        <ul>
          <li>건설분쟁 전문: 500건+ 해결, 승소율 92%</li>
          <li>형사변호 전문: 800건+ 경험</li>
          <li>월평균 80건 직접 상담</li>
          <li>현장 방문 월 20회</li>
          <li>의뢰인 만족도 96%</li>
        </ul>
        <address>
          부산광역시 연제구 법원남로 18 세헌빌딩 5층, 전화: 051-507-7000
        </address>
      </div>
      <CommonContainer sx={{}}>
